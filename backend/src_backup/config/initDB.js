...
const createTables = async () => {
  ...
  try {
    ...
    const adminEmails = (process.env.ADMIN_EMAILS || 'mulimaniganesh0@gmail.com,priyabp1008@gmail.com,jyotihitnalli45@gmail.com,jyotimathapati82@gmail.com').split(',');
    ...
    console.log(`Emails: ${process.env.ADMIN_EMAILS || 'mulimaniganesh0@gmail.com, etc.'}`);
    console.log('Password: majorproject@123');
